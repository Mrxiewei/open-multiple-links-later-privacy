...
- [`privacy-policy.html`](./privacy-policy.html) —— 面向用户的隐私政策页面（部署后由 GitHub Pages 发布）。

## 说明

CharlieLinks 全部功能与数据均在你本地浏览器运行，**不收集、不存储、不上传任何用户数据**，仅申请实现功能所必需的最小权限（`tabs`、`storage`、`notifications`、`alarms`）。
